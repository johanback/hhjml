...
public class MarvelQuiz implements Quiz {
    ...
    private Result result1 = new Result("Iron-man", "Genius. Billionaire. Playboy. Philanthropist.", "parmesan.jpg");
    private Result result2 = new Result("Hulk", "Dr. Bruce Banner lives a life caught between the soft-spoken scientist he’s always been and the uncontrollable green monster powered by his rage.", "gouda.jpg");
    private Result result3 = new Result("Captian America", "Recipient of the Super-Soldier serum, World War II hero Steve Rogers fights for American ideals as one of the world’s mightiest heroes and the leader of the Avengers.", "cheddar.jpg");
    ...
    public MarvelQuiz() {
        getQuestionArray().add(new Question("What kind of pizza do you like?", "Oxfile pizza", "Kebabpizza", "Margarita", "Calzone"));
