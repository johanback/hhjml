...
--
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (1, 'A', 'Parmesan', 'Parmigiano-Reggiano or Parmesan is an Italian hard, granular cheese. It has been called the "King of Cheeses" and a "practically perfect food".', '/parmesan.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (1, 'B', 'Gouda', 'Gouda is a mild, yellow cheese, originating from the Netherlands, made from cow\'s milk. It is one of the most popular cheeses worldwide.', '/gouda.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (1, 'C', 'Cheddar', 'Cheddar cheese is a relatively hard, off-white or orange if colourings such as annatto are added), sometimes sharp-tasting, natural cheese. Originating in the English village of Cheddar in Somerset, cheeses of this style are now produced beyond the region and in several countries around the world.', '/cheddar.jpg '');
...
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (2, 'A', 'Boots', 'A boot, plural boots, is a type of specific footwear. Most boots mainly cover the foot and the ankle, while some also cover some part of the lower calf.', '/boots.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (2, 'B', 'Pumps', 'A court shoe (British English), coort shoe (Scottish English), or pump (American English), is a shoe with a low-cut front, or vamp, with either a shoe buckle or a black bow as ostensible fastening.', '/pumps.jpg'');
...
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (3, 'A', 'Iron-man', 'Genius. Billionaire. Playboy. Philanthropist.', '/iron man.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (3, 'B', 'Hulk', 'Dr. Bruce Banner lives a life caught between the soft-spoken scientist he’s always been and the uncontrollable green monster powered by his rage.', '/hulc.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (3, 'C', 'Captian America', 'Recipient of the Super-Soldier serum, World War II hero Steve Rogers fights for American ideals as one of the world’s mightiest heroes and the leader of the Avengers.', '/captain america.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (3, 'D', 'Thor', 'The son of Odin uses his mighty abilities as the God of Thunder to protect his home Asgard and planet Earth alike.', '/Ebba thor.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (4, 'A', 'Audi', 'Audi AG is a German automobile manufacturer that designs, engineers, produces, markets and distributes luxury vehicles.', '/audi.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (4, 'B', 'Renault', 'Groupe Renault is a French multinational automobile manufacturer established in 1899. The company produces a range of cars and vans, and in the past has manufactured trucks, tractors, tanks, buses/coaches, aircraft and aircraft engines, and autorail vehicles.', '/renault.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (4, 'C', 'Tesla', 'Tesla, Inc. (formerly Tesla Motors, Inc.), is an American electric vehicle and clean energy company based in Palo Alto, California.', '/tesla.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (4, 'D', 'Mini', 'Mini is a British automotive marque founded in 1969, owned by German automotive company BMW since 2000, and used by them for a range of small cars.', '/mini.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (5, 'A', 'Death metal', 'Hard, fast and with indecipherable vocals, you make everyone\'s friends shift in their seats when someone puts you on during a party.', '/deathmetal.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (5, 'B', 'Jazz', 'Technical, inaccessible and elitist, you turn your listeners into the most obnoxious people around, ruining friendships and relationships alike.', '/jazz.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (5, 'C', 'Pop', 'Simple, easy to listen to, and commercially viable, you are the envy of the other genres, although they would never dare admit it.', '/pop.jpg'');
...
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (6, 'A', 'Thomas the tank engine', 'Thomas the Tank Engine is a fictional anthropomorphised steam locomotive in The Railway Series books by the Reverend Wilbert Awdry and his son, Christopher, published from 1945.', '/thomastank.jpeg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (6, 'B', 'Rc4', 'The SJ Class Rc is the most used electric locomotive in Sweden. Rc is a universal locomotive used both in freight and passenger trains.', '/Rc4.jpg'');
...
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (7, 'A', 'Ludwig', 'Ludwig likes trains.', '/ludwig.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (7, 'B', 'Johan', 'Johan is quite tall.', '/johan.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (7, 'C', 'Henrik', 'Henrik likes plaid shirts and screwdrivers.', '/henrik.jpg'');
--INSERT INTO Answer (quizID, resultChar, result, description, imgUrl) VALUES (7, 'D', 'Hanna', 'Hanna often secretly takes pictures of strangers\'  dogs on the subway.', '/Hanna.jpg'');
--
--
--
